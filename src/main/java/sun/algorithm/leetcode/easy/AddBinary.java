 ...
 * Return "100".
 * <p>
 * Reference: <a href="https://leetcode.com/problems/add-binary/description/"> Add Binary </a>
 * Difficulty: Easy
 *
 * @author hufeng
...
public class AddBinary {
    ...
    public void testNormalCase3() {
        assertEquals("10000", addBinary("1101", "11"));
    }

    @Test
    public void testNormalCase4() {
        assertEquals("10000", addBinary("11", "1101"));
    }

    @Test
    public void testNormalCase5() {
        assertEquals("1101", addBinary2("", "1101"));
    }
}
