 ...
 * return false
 * <p>
 * Reference: <a href="https://leetcode.com/problems/is-subsequence/description/">Is SubSequence</a>
 *
 * @author hufeng
...
public class IsSubsequence {
    ...
    public void testNormalCase() {
        ...
        String s1 = "abc";
        String s2 = "axc";
        assertTrue(isSubSequence(s1, t));
        assertTrue(!isSubSequence(s2, t));
    }
...
//        String t = "yyyyylyyyyyyy";
        String s = "leeeeetcode";
        assertTrue(!isSubSequence2(s, t));
//        assertTrue(!isSubSequence(s, t));
    ...
    public void testLoopMethod() {
        ...
        String s1 = "abc";
        String s2 = "axc";
        assertTrue(isSubSequence2(s1, t));
        assertTrue(!isSubSequence2(s2, t));
    }

    @Test
    public void testEmpty() {
        assertTrue(isSubSequence2("", ""));
    }
